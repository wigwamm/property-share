...
(function() {
  $.fn.exchangePositionWith = function(selector) {
    ...
    return other.after(this).remove();
  };

}).call(this);
(function(c){c(window.jQuery,window,document)})(function(c,m,v,w){c.widget("selectBox.selectBoxIt",{VERSION:"3.8.1",options:{showEffect:"none",showEffectOptions:{},showEffectSpeed:"medium",hideEffect:"none",hideEffectOptions:{},hideEffectSpeed:"medium",showFirstOption:!0,defaultText:"",defaultIcon:"",downArrowIcon:"",theme:"default",keydownOpen:!0,isMobile:function(){return/iPhone|iPod|iPad|Silk|Android|BlackBerry|Opera Mini|IEMobile/.test(navigator.userAgent||navigator.vendor||m.opera)},"native":!1,
...
return this},_createUnorderedList:function(){var a=this,b,d,f,g,e,t,h,r="",l=a.originalElemId||"",l=c("<ul/>",{id:l&&l+"SelectBoxItOptions","class":"selectboxit-options",tabindex:-1}),p,u,s,n,k,q;a.options.showFirstOption||(a.selectItems.first().attr("disabled","disabled"),a.selectItems=a.selectBox.find("option").slice(1));a.selectItems.each(function(l){k=c(this);f=d="";b=k.prop("disabled");g=k.attr("data-icon")||"";t=(e=k.attr("data-iconurl")||"")?"selectboxit-option-icon-url":"";h=e?"style=\"background-image:url('"+
e+"');\"":"";p=k.attr("data-selectedtext");n=(u=k.attr("data-text"))?u:k.text();q=k.parent();q.is("optgroup")&&(d="selectboxit-optgroup-option",0===k.index()&&(f='<span class="selectboxit-optgroup-header '+q.first().attr("class")+'"data-disabled="true">'+q.first().attr("label")+"</span>"));k.attr("value",this.value);r+=f+'<li data-id="'+l+'" data-val="'+this.value+'" data-disabled="'+b+'" class="'+d+" selectboxit-option "+(c(this).attr("class")||"")+'"><a class="selectboxit-option-anchor"><span class="selectboxit-option-icon-container"><i class="selectboxit-option-icon '+
g+" "+(t||a.theme.container)+'"'+h+"></i></span>"+(a.options.html?n:a.htmlEscape(n))+"</a></li>";s=k.attr("data-search");a.textArray[l]=b?"":s?s:n;this.selected&&(a._setText(a.dropdownText,p||n),a.currentFocus=l)});if(a.options.defaultText||a.selectBox.attr("data-text")){var m=a.options.defaultText||a.selectBox.attr("data-text");a._setText(a.dropdownText,m);a.options.defaultText=m}l.append(r);a.list=l;a.dropdownContainer.append(a.list);a.listItems=a.list.children("li");a.listAnchors=a.list.find("a");
...
return this},_setText:function(a,b){this.options.html?a.html(b):a.text(b);return this},open:function(a){var b=this,c=b.options.showEffect,f=b.options.showEffectSpeed,g=b.options.showEffectOptions,e=b.options["native"],h=b.isMobile;if(!b.listItems.length||b.dropdown.hasClass(b.theme.disabled))return b;if(!e&&!h&&!this.list.is(":visible")){b.triggerEvent("open");b._dynamicPositioning&&b.options.dynamicPositioning&&b._dynamicPositioning();if("none"===c)b.list.show();else if("show"===c||"slideDown"===
c||"fadeIn"===c)b.list[c](f);else b.list.show(c,g,f);b.list.promise().done(function(){b._scrollToView("search");b.triggerEvent("opened")})}b._callbackSupport(a);return b},close:function(a){var b=this,c=b.options.hideEffect,f=b.options.hideEffectSpeed,g=b.options.hideEffectOptions,e=b.isMobile;if(!b.options["native"]&&!e&&b.list.is(":visible")){b.triggerEvent("close");if("none"===c)b.list.hide();else if("hide"===c||"slideUp"===c||"fadeOut"===c)b.list[c](f);else b.list.hide(c,g,f);b.list.promise().done(function(){b.triggerEvent("closed")})}b._callbackSupport(a);
...
a.close()},backspace:function(){a.triggerEvent("backspace")},esc:function(){a.close()}}},_eventHandlers:function(){var a=this,b=a.options.nativeMousedown,d=a.options.customShowHideEvent,f,g,e=a.focusClass,h=a.hoverClass,m=a.openClass;this.dropdown.on({"click.selectBoxIt":function(){a.dropdown.trigger("focus",!0);a.originalElem.disabled||(a.triggerEvent("click"),b||d||a.toggle())},"mousedown.selectBoxIt":function(){c(this).data("mdown",!0);a.triggerEvent("mousedown");b&&!d&&a.toggle()},"mouseup.selectBoxIt":function(){a.triggerEvent("mouseup")},
"blur.selectBoxIt":function(){a.blur&&(a.triggerEvent("blur"),a.close(),c(this).removeClass(e))},"focus.selectBoxIt":function(b,d){var p=c(this).data("mdown");c(this).removeData("mdown");p||d||setTimeout(function(){a.triggerEvent("tab-focus")},0);d||(c(this).hasClass(a.theme.disabled)||c(this).addClass(e),a.triggerEvent("focus"))},"keydown.selectBoxIt":function(b){var c=a._keyMappings[b.keyCode],d=a._keydownMethods()[c];d&&(d(),!a.options.keydownOpen||"up"!==c&&"down"!==c||a.open());d&&"tab"!==c&&
...
"enable.selectBoxIt":function(){a.dropdown.removeClass(a.theme.disabled)},"open.selectBoxIt":function(){var b=a.list.find("li[data-val='"+a.dropdownText.attr("data-val")+"']");b.length||(b=a.listItems.not("[data-disabled=true]").first());a.currentFocus=+b.attr("data-id");b=a.listItems.eq(a.currentFocus);a.dropdown.addClass(m).removeClass(h).addClass(e);a.listItems.removeClass(a.selectedClass).removeAttr("data-active").not(b).removeClass(e);b.addClass(a.selectedClass).addClass(e);a.options.hideCurrent&&
(a.listItems.show(),b.hide())},"close.selectBoxIt":function(){a.dropdown.removeClass(m)},"blur.selectBoxIt":function(){a.dropdown.removeClass(e)},"mouseenter.selectBoxIt":function(){c(this).hasClass(a.theme.disabled)||a.dropdown.addClass(h)},"mouseleave.selectBoxIt":function(){a.dropdown.removeClass(h)},destroy:function(a){a.preventDefault();a.stopPropagation()}});return a},_update:function(a){var b,c=this.options.defaultText||this.selectBox.attr("data-text"),f=this.listItems.eq(this.currentFocus);
...
a=a.clone();var b;a.css({visibility:"hidden",display:"block",position:"absolute"}).appendTo("body");b=a.outerWidth(!0);a.remove();return b}});var h=c.selectBox.selectBoxIt.prototype;h.moveDown=function(a){this.currentFocus+=1;var b="true"===this.listItems.eq(this.currentFocus).attr("data-disabled")?!0:!1,c=this.listItems.eq(this.currentFocus).nextAll("li").not("[data-disabled='true']").first().length;if(this.currentFocus===this.listItems.length)this.currentFocus-=1;else{if(b&&c){this.listItems.eq(this.currentFocus-
1).blur();this.moveDown();return}b&&!c?this.currentFocus-=1:(this.listItems.eq(this.currentFocus-1).blur().end().eq(this.currentFocus).focusin(),this._scrollToView("down"),this.triggerEvent("moveDown"))}this._callbackSupport(a);return this};h.moveUp=function(a){this.currentFocus-=1;var b="true"===this.listItems.eq(this.currentFocus).attr("data-disabled")?!0:!1,c=this.listItems.eq(this.currentFocus).prevAll("li").not("[data-disabled='true']").first().length;if(-1===this.currentFocus)this.currentFocus+=
1;else{if(b&&c){this.listItems.eq(this.currentFocus+1).blur();this.moveUp();return}b&&!c?this.currentFocus+=1:(this.listItems.eq(this.currentFocus+1).blur().end().eq(this.currentFocus).focusin(),this._scrollToView("up"),this.triggerEvent("moveUp"))}this._callbackSupport(a);return this};h._updateMobileText=function(){var a,b;a=this.selectBox.find("option").filter(":selected");b=(b=a.attr("data-text"))?b:a.text();this._setText(this.dropdownText,b);this.list.find('li[data-val="'+a.val()+'"]').find("i").attr("class")&&
this.dropdownImage.attr("class",this.list.find('li[data-val="'+a.val()+'"]').find("i").attr("class")).addClass("selectboxit-default-icon")};h._applyNativeSelect=function(){this.dropdownContainer.append(this.selectBox);this.dropdown.attr("tabindex","-1");this.selectBox.css({display:"block",visibility:"visible",width:this._realOuterWidth(this.dropdown),height:this.dropdown.outerHeight(),opacity:"0",position:"absolute",top:"0",left:"0",cursor:"pointer","z-index":"999999",margin:this.dropdown.css("margin"),
...
(function() {
  jQuery(function() {
    var $, $header_wrapper, $home_link, $prop_wrapper, $scroll, completeH, delayTime, home_link_text, propHeight, propOff, restore, setSizes, targetH;
    $ = jQuery;
    delayTime = 1800;
    $home_link = $("#home_link");
    ...
    restore = function($this) {
      return setTimeout(function() {
        ...
        return $this.children("ul").removeClass("menu_large");
      }, delayTime);
    };
    setSizes = function() {
      var $property_title;
      ...
      return $prop_wrapper.css("marginTop", completeH);
    };
    setSizes();
    $(window).on({
      resize: function() {
        if (typeof $header_wrapper !== "undefined") {
          setSizes();
          return $header_wrapper.css("height", completeH);
        }
      }
    });
    $("#action_button").on({
      click: function(event) {
        ...
        return $actions_expand.stop().slideToggle(600, "easeOutBack");
      }
    });
    $("#header_expand").on({
      click: function() {
        $home_link.text("PS");
        return $(this).parent("ul").addClass("menu_large");
      }
    });
    $("header").on({
      mouseleave: function() {
    ...
    $(".close_dialog").on({
      mouseup: function(event) {
        ...
        return $($(this).data('target')).fadeOut(400);
      }
    });
    if (typeof $header_wrapper !== "undefined") {
      return setSizes();
...
(function() {
  ...
  $(function() {
    var $imageUploadForm, $imageUploadsContainer, dotDotDot, dropTarget, error_message, propertyValidator;
    dropTarget = $('#images_upload');
    $imageUploadForm = $('#s3_uploader');
    $imageUploadsContainer = $('#property_images');
    dotDotDot = function(target, speed) {
      var dot, dotCount;
      dotCount = 1;
      dot = function() {
        if (dotCount % 50 === 0) {
    ...
    dropTarget.on({
      mouseup: function(e) {
        ...
        return window["link_clicked"] = false;
      }
    });
    (function() {
      ...
      return $imageUploadForm.bind({
        s3_upload_failed: function(e, content) {
          return console.log(content.filename + ' failed to upload');
        },
        s3_upload_worked: function(e, content) {
          return console.log(content.filename + ' failed to upload');
        },
        s3_uploads_complete: function(e) {
          return $("a.btn").removeClass("disabled").text("Publish and Share");
        },
        s3_uploads_start: function(e) {
          return $("a.btn").addClass("disabled").text("Uploading");
        }
      });
    })();
    ...
    $.validator.addMethod("postalzip", function(value, element) {
      return this.optional(element) || /[A-Z]{1,2}[0-9][0-9A-Z]?\s?[0-9][A-Z]{2}/g.test(value);
    }, "No zip or postcode");
    $.validator.addMethod("spaced", function(value, element) {
      return this.optional(element) || /[A-Z]{1,2}[0-9][0-9A-Z]?\s?[0-9][A-Z]{2}/g.test(value);
    }, "No zip or postcode");
    error_message = function(object, target) {
      var formErrors, message;
      formErrors = object.numberOfInvalids();
      target = $(target);
      if (formErrors) {
        message = formErrors === 1 ? "<p>" + object.errorList[0].message + "</p>" : '<p>Please fill in the form correctly, there\'s ' + formErrors + ' errors</p>';
        target.html(message);
    ...
    propertyValidator = $('#property-form').validate({
      ...
      errorPlacement: function(label, element) {
        return label.addClass('error_message');
      },
      highlight: function(element, errorClass, validClass) {
        var $element;
        $element = $(element);
        if ($element.data('highlight')) {
          return $($element.data('highlight')).addClass(errorClass + " invalid").removeClass(validClass);
        } else {
          return $element.addClass(errorClass + " invalid").removeClass(validClass);
        }
      },
      unhighlight: function(element, errorClass, validClass) {
        var $element;
        ...
        return error_message(propertyValidator, "div.error_messages");
      },
      invalidHandler: function(event, validator) {
        return error_message(validator, "div.error_messages");
      },
    ...
    return dotDotDot('div.processing_image .dot', 1000);
  });
