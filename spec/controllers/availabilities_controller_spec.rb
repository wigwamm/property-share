...
#       @agent = agent
#       @valid_attributes = attributes_for(:availability, agent_id: @agent.id)
#       @valid_advanced_attributes = attributes_for(:advanced_availability, agent_id: @agent.id)
...
#       #   Availability.any_instance.should_receive(:update_attributes).with( @valid_attributes )
...
#       it "assigns the requested availability as @availability" do
#         availability = Availability.create! @valid_advanced_attributes
#         put :update, {:id => availability.to_param, :availability => @valid_advanced_attributes}, valid_session
#         assigns(:availability).should eq(availability)
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Availability.any_instance.stub(:save).and_return(false)
#         put :update, {:id => availability.to_param, :availability => { "start_time" => "invalid value" }}, valid_session
#         assigns(:availability).should eq(availability)
#       end
