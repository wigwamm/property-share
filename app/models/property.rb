class Property
  ...
  field :date_available,          type: Time    # Must be set to the format below "dd-MM-yyyy"
  ...
  validates_presence_of :street, :postcode, :url, :title, :bedrooms, :saleorlet, :property_type, :status, :published, :tenure_type, :tenure_unexpired_years
